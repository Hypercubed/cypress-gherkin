...
When('I press the {ordinal} key of my piano', (args) => steps.press(args));

Then('I should hear a(n) {note} sound', (args) => steps.hear(args));

// ** OR  **

describe('calls steps and parameters', () => {
  beforeEach(() => {
